 ...
 * 
 * @author salal
 *These Menus will display all system choices and perform all actions by calling Service
 *class methods.
 */
public class Menus {
	...
	public void lib3(int branchID, String branchName) {
		...
		//This is the display id on the menu, the true value in the arraylist is branchId
